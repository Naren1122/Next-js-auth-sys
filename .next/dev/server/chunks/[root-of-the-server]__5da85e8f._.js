...
"[project]/src/app/api/users/forgot-password/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const validationResult = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validations$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["emailSchema"].safeParse(reqBody);
        ...
        const forgotPasswordToken = Math.random().toString(36).substring(2, 15) + Math.random().toString(36).substring(2, 15);
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$email$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendPasswordResetEmail"])(email, forgotPasswordToken);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5da85e8f._.js.map